...
import cc.mrbird.febs.system.mapper.DictTypeMapper;
...
public class DictTypeServiceImpl extends ServiceImpl<DictTypeMapper, DictType> implements IDictTypeService {
    ...
    @Override
    public IPage<DictType> findDictTypes(QueryRequest request, DictType dictType) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public void deleteDictType(DictType dictType) {
